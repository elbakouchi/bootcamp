...
from bootcamp.tracking.models import Visitor, Pageview
from bootcamp.tracking.settings import TRACK_PAGEVIEWS
...
def dashboard(request):
    ...
    return render(request, 'redico/tracking/dashboard.html', context)
