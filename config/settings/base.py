...
LOCAL_APPS = [
    ...
    "bootcamp.category.apps.CategoryConfig",
    "bootcamp.demand.apps.DemandsConfig",
...
MIDDLEWARE = [
    ...
    "bootcamp.tracking.middleware.VisitorTrackingMiddleware",
